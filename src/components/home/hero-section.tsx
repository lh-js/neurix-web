        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          <ScrollReveal direction="up" delay={100}>
            <h1 className="mb-6 text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl lg:text-7xl">
              <span
                className="animate-fade-in-up inline-block bg-gradient-to-r from-foreground via-foreground/90 to-foreground/70 bg-clip-text text-transparent"
              ...
              <br />
              <span
                className="animate-fade-in-up inline-block bg-gradient-to-r from-primary via-primary/90 to-primary/70 bg-clip-text text-transparent animate-gradient"
          ...
          <div className="mt-16 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {[
              { title: '智能对话', desc: '多轮对话，上下文理解', delay: 100 },
              { title: '代码生成', desc: '快速生成和优化代码', delay: 200 },
              { title: '文案创作', desc: '各类文案一键生成', delay: 300 },
              { title: '数据分析', desc: '智能分析和总结', delay: 400 },
            ].map((item, idx) => (
              <ScrollReveal key={idx} direction="up" delay={item.delay}>
                <div className="group relative overflow-hidden rounded-xl border border-border/60 bg-background/80 p-5 backdrop-blur-sm transition-all hover:border-primary/50 hover:shadow-lg hover-lift">
