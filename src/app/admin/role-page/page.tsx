...
import { RolePage, CreateRolePageRequest } from '@/service/types/role-page'
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-3">
          ...
          <h1 className="text-3xl font-bold text-foreground">页面权限管理</h1>
        </div>
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>{editingItem ? '编辑页面权限' : '新增页面权限'}</DialogTitle>
            <DialogDescription>
              {editingItem ? '修改页面权限信息' : '创建一个新的页面权限'}
            </DialogDescription>
          </DialogHeader>
          {dialogLoading ? (
