...
import { LogIn, Search, CheckCircle2, XCircle, Key, Mail, Eye } from 'lucide-react'
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
            <DialogHeader>
              ...
              <DialogDescription>查看登录记录的完整信息</DialogDescription>
            </DialogHeader>
            {selectedRecord && (
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm mt-1">
                      {selectedRecord.loginType === 'password' ? '密码登录' : '验证码登录'}
                    </p>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-muted-foreground">登录状态</label>
                  ...
                  <div>
                    <label className="text-sm font-medium text-muted-foreground">登录时间</label>
                    <p className="text-sm mt-1">
                      {selectedRecord.loginTime
                        ? new Date(selectedRecord.loginTime).toLocaleString('zh-CN')
                        : '-'}
                    </p>
                  </div>
                  <div>
